# Generated by Django 5.2.5 on 2025-08-16 16:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name_ru', models.CharField(max_length=255, null=True, verbose_name='Имя')),
                ('name_uz', models.CharField(max_length=255, null=True, verbose_name='Имя')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='akkumlyatory.category', verbose_name='Родительская категория')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='akkumlyatory.category', verbose_name='Категория')),
            ],
            options={
                'verbose_name': 'Товар',
