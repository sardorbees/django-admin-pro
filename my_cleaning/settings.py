...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"name": "Cкидка товоров", "title": "Swagger", "url": "http://127.0.0.1:8000/admin/product_skidka/"},
        {"name": "Новинки товара", "title": "Swagger", "url": "http://127.0.0.1:8000/admin/new_product/product/"},
        {"name": "Популарные категория", "title": "Swagger", "url": "http://127.0.0.1:8000/api/category_all/laptops/"},
        {"name": "Нашы проекты", "title": "Swagger", "url": "http://127.0.0.1:8000/api/our_project/cards/"},
        {"name": "Почему нас", "title": "Swagger", "url": "http://127.0.0.1:8000/admin/our_me/"},
        {"name": "Наш процесс", "title": "Swagger", "url": "http://127.0.0.1:8000/admin/prosses/processstep/"},
        {"name": "О комнании", "title": "Swagger", "url": "http://127.0.0.1:8000/admin/category/category/"},
        {"model": "auth.User"},
        {"app": "books"},
    ],
    "custom_links": {
    ...
    "usermenu_links": [
        ...
        {"name": "Видео", "url": "http://127.0.0.1:8000/admin/banner_video/bannervideo/"},
        {"name": "Нашы Бренд", "title": "Swagger", "url": "http://127.0.0.1:8000/admin/shop_category/brand/"},
        {"model": "auth.user"}
    ],
