...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Xush Kelibsiz Solar Energy",
    "copyright": "Solar Energy-Admin",
    "user_avatar": "../media/assets/img/1111.jpg",
    "dashboard": [
        {"type": "link", "title": "Documentation", "url": "http://127.0.0.1:8000/swagger/"},
    ],
    "topmenu_links": [
        {"name": "СОЛНЕЧНЫЕ ПАНЕЛИ", "url": "https://django-admin-pro.onrender.com/admin/solnechnye_paneli/", "permissions": ["auth.view_user"]},
        {"name": "ИНВЕРТОРЫ", "url": "https://django-admin-pro.onrender.com/admin/invertory/", "permissions": ["auth.view_user"]},
        {"name": "CТАБИЛИЗАТОРЫ", "title": "Swagger", "url": "https://django-admin-pro.onrender.com/admin/ctabilizatory/"},
        {"name": "АККУМЛЯТОРЫ", "title": "Swagger", "url": "https://django-admin-pro.onrender.com/admin/akkumlyatory/product/"},
        {"name": "CОЛНЕЧНЫЙ ОСВЕЩЕНИЯ", "title": "Swagger", "url": "https://django-admin-pro.onrender.com/admin/colnechnyj_osvesheniya/"},
        {"name": "ДИЗЕЛЬ ГЕНЕРАТОРЫ", "title": "Swagger", "url": "https://django-admin-pro.onrender.com/admin/dizel_generatory/"},
        {"name": "Cкидка товоров", "title": "Swagger", "url": "https://django-admin-pro.onrender.com/admin/product_skidka/"},
        {"name": "Новинки товара", "title": "Swagger", "url": "https://django-admin-pro.onrender.com/admin/new_product/"},
        {"name": "Популарные категория", "title": "Swagger", "url": "https://django-admin-pro.onrender.com/admin/category_all/"},
        {"name": "Нашы проекты", "title": "Swagger", "url": "https://django-admin-pro.onrender.com/admin/our_project/"},
        {"name": "Почему нас", "title": "Swagger", "url": "https://django-admin-pro.onrender.com/admin/our_me/"},
        {"name": "Наш процесс", "title": "Swagger", "url": "https://django-admin-pro.onrender.com/admin/prosses/"},
        {"name": "О комнании", "title": "Swagger", "url": "https://django-admin-pro.onrender.com/admin/category/"},
        {"model": "auth.User"},
        {"app": "books"},
    ],
    "custom_links": {
    ...
    "usermenu_links": [
        ...
        {"name": "ЗАРЯДНЫЙ СТАНЦИИ", "url": "https://django-admin-pro.onrender.com/admin/zaryadnyj_stancii/"},
        {"name": "ВЕТРОВАЯ ЭЛЕКТРОСТАНЦИИ", "url": "https://django-admin-pro.onrender.com/admin/vetrovaya_elektrostancii/"},
        {"name": "ИНДИВИДУАЛЬНЫЙ ТЕПЛОВОЙ ПУНКТ", "url": "https://django-admin-pro.onrender.com/admin/individualnyj_teplovoj_punkt/"},
        {"name": "Видео", "url": "https://django-admin-pro.onrender.com/admin/banner_video/"},
        {"name": "Наши Товары", "title": "Swagger", "url": "https://django-admin-pro.onrender.com/admin/shop_category/"},
        {"name": "Andeli", "title": "Swagger", "url": "https://django-admin-pro.onrender.com/admin/andeli/product/"},
        {"model": "auth.user"}
    ],
